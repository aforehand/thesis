...
#intro text
text {caption = "Click the mouse when you see a letter from two positions back repeated. It is important that your score is at least as high as it was in the first condition. Focus only on the letters at the center of the screen and do not move during the experiment.\n
...
double before_trans_time = 5.8e4;#5.8e4;#time before switching from the non-target images in ms
